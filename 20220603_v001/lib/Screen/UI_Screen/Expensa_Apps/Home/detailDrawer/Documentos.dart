...
class documentosDetail extends StatefulWidget {
  @override
  _documentosDetailState createState() => _documentosDetailState();
}

class _documentosDetailState extends State<documentosDetail> {
  @override
