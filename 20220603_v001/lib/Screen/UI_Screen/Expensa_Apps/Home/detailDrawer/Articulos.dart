...
class articulosDetail extends StatefulWidget {
  @override
  _articulosDetailState createState() => _articulosDetailState();
}

class _articulosDetailState extends State<articulosDetail> {
  @override
