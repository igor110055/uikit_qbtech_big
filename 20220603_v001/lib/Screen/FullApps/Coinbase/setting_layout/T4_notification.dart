import 'package:biggest_kit_flutter_null_safety/Screen/FullApps/Coinbase/model_data/notification_model.dart';
...
class _T4_notificationState extends State<T4_notification> {
  ...
  void initState() {
    ...
    setState(() {
      items.add(
        Post(
            image: "lib/Screen/FullApps/Coinbase/Assets/buildingMenu.png",
            id: 1,
            title: "Bank Account",
