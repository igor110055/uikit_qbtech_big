...
import 'package:biggest_kit_flutter_null_safety/Screen/FullApps/SunriseMart/B4_MyOrder_Screen/Step_Order/paymentMethod.dart';
import 'package:biggest_kit_flutter_null_safety/Screen/FullApps/SunriseMart/Bottom_Nav_Bar/BottomNavigationBar.dart';
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: <Widget>[
                                Image.asset(
                                  "lib/Screen/FullApps/SunriseMart/Assets/house.png",
                                  height: 30.0,
                                ),
                                Padding(
                                  padding: const EdgeInsets.only(
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: <Widget>[
                                Image.asset(
                                  "lib/Screen/FullApps/SunriseMart/Assets/paypal.png",
                                  height: 30.0,
                                ),
                                Padding(
                                  padding: const EdgeInsets.only(
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: <Widget>[
                                Image.asset(
                                  "lib/Screen/FullApps/SunriseMart/Assets/money.png",
                                  height: 19.0,
                                ),
                                Padding(
                                  padding: const EdgeInsets.only(
    ...
    builder: (BuildContext context) => SimpleDialog(
      children: <Widget>[
        Container(
          ...
          color: Colors.white,
          child: Image.asset(
            "lib/Screen/FullApps/SunriseMart/Assets/checklist.png",
            height: 110.0,
          ),
        ),
        Center(
